...
<form action="{{ route('admin.profile.store') }}" method="post" enctype="multipart/form">        
        <div class="row">
            <div class="col-lg-6">
                <div>
                    <div class="mb-3">
            ...
            <div class="col-lg-6">
                <div class="mt-3 mt-lg-0">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" value="{{ $profileData->address }}" id="example-text-input">
                    </div>
                    <div class="mb-3">
