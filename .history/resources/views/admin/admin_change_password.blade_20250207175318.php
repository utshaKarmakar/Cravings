            ...
            <div class="col-lg-6">
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('new_password_confirmation') is-invalid @enderror" name="new_password_confirmation" type="password" id="new_password">
                        @error('new_password')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary wave-effect wave-light">Save Changes</button>
                </div>
            </div>
