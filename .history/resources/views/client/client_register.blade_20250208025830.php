                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt="" height="28"> <span class="logo-txt">Cravings Restaurant</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Welcome Back !</h5>
                                            <p class="text-muted mt-2">Sign up to continue to Cravings Restaurants.</p>
                                        </div>
...
<form class="mt-4 pt-2" action="{{route('admin.login_submit')}}" method="post" >
    ...
    <div class="mb-3">
        ...
        <input type="email" name="address" class="form-control" id="address" placeholder="Enter Your Address">
    </div>
