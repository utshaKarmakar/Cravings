<div class="col-md-3">
                  <div class="osahan-account-page-left shadow-sm rounded bg-white h-100">
                     ...
                     <li class="nav-item">
                           <a class="nav-link active" id="orders-tab" data-toggle="tab" href="{{ route('dashboard') }}s" role="tab" aria-controls="orders" aria-selected="true"><i class="icofont-food-cart"></i> Profile</a>
                        </li>
