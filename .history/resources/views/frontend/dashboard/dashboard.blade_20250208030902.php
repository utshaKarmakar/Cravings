                           ...
                           <div class="row mb-4 pb-2">
                              <div class="col-md-6">
                                 <div class="card offer-card shadow-sm">
                                    <div class="card-body">
                                       <h5 class="card-title"><img src="img/bank/1.png"> CRAVINGEAT50</h5>
                                       <h6 class="card-subtitle mb-2 text-block">Get 50% OFF on your first Craving eat order</h6>
                                       <p class="card-text">Use code OSAHANEAT50 &amp; get 50% off on your first Craving order on Website and Mobile site. Maximum discount: $200</p>
