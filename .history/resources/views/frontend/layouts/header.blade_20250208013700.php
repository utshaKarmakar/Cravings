            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
                        <a class="dropdown-item" href="track-order.blade.php">Track Order</a>
                        <a class="dropdown-item" href="invoice.blade.php">Invoice</a>
                        <a class="dropdown-item" href="login.blade.php">Login</a>
                        <a class="dropdown-item" href="register.blade.php">Register</a>
                        <a class="dropdown-item" href="404.blade.php">404</a>
                        <a class="dropdown-item" href="extra.blade.php">Extra :)</a>
                     </div>
                  </li>
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
