...
Route::middleware('client')->group(function () {
    ...
    Route::get('/client/change/client_password', [ClientController::class, 'ClientChangePassword'])->name('client.client_change.password');
    Route::post('/client/password/client_update', [ClientController::class, 'ClientPasswordUpdate'])->name('client.client_password.update');
});
...
Route::get('/client/client_forget_password', [ClientController::class, 'ClientForgetPassword'])->name('client.client_forget_password');
Route::post('/client/client_password_submit', [ClientController::class, 'ClientPasswordSubmit'])->name('client.client_password_submit');

Route::get('/client/client_reset_password/{token}/{email}', [ClientController::class, 'ClientResetPassword']);
Route::post('/client/client_reset_password_submit', [ClientController::class, 'ClientResetPasswordSubmit'])->name('client.client_reset_password_submit');
