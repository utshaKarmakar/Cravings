...
Route::post('/client/login_submit', [AdminController::class, 'ClientLoginSubmit'])->name('client.login_submit');

Route::post('/client/login_submit', [AdminController::class, 'ClientRegisterSubmit'])->name('client.login_submit');