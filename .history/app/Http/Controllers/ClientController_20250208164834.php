...
class ClientController extends Controller
{
    ...
    public function ClientRegistClientLoginSubmiterSubmit(Request $request){
        $request->validate([
        ...
        return redirect()->route('client.client_login')->with('success', 'Registration successful ! Please login.');
    }
